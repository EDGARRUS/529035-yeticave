...
ALTER TABLE users ADD CONSTRAINT FOREIGN KEY (lots_id)  REFERENCES lots (Id) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE users ADD CONSTRAINT FOREIGN KEY (bets_id)  REFERENCES bets (Id) ON DELETE CASCADE ON UPDATE CASCADE;